...
class SubjectCrudController extends CrudController
{
    ...
    public function setPermissions()
    {
        ...
        // Allow list access
        if ($user->can('list_subject')) {
            $this->crud->allowAccess('list');
        }

        // Allow create access
        if ($user->can('create_subject')) {
    ...
    protected function setupCreateOperation()
    {
        ...
        $this->crud->addField([
            'label' => 'Criteria',
            'type' => 'select2',
            'name' => 'criteria_id', // the db column for the foreign key
            'entity' => 'criteria', // the method that defines the relationship in your Model
            'attribute' => 'name', // foreign key attribute that is shown to user
            'model' => 'App\Models\Criteria' // foreign key model
        ]);
