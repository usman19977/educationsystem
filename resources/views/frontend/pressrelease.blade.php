    ...
    <div class="container">
      <div class="row no-gutters slider-text align-items-center justify-content-center">
        <div class="col-md-9 text-center fadeInUp ftco-animated">
          <h1 class="mb-2 bread">Press Release</h1>
  ...
  <div style="padding: 10%">
    ...
    <!-- col-8 starts -->
            <div class="col-lg-12  col-12">
                <div class="row">
                    @foreach ($data['content'] as $release )

                  <div style="padding: 2%">
                    <a class="fancybox" rel="group" href="{{ url($release->image) }}"><img height=400 width=300 src="{{ url($release->image) }}" alt="" /></a>

                    <h1 style="padding:10px">{{ ucfirst($release->name)}}</h1>
                    <h4 style="padding:10px">{{ ucfirst($release->created_at)}}</h4>
